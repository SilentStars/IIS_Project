    ...
    with hands.Hands(
        ...
        for idx, file in enumerate(frames):
            ...
            for hand_landmarks in results.multi_hand_landmarks:
                ...
                # joints.append((hand_landmarks.landmark[hands.HandLandmark.WRIST].x * image_width,
                #         hand_landmarks.landmark[hands.HandLandmark.WRIST].y * image_height))
                # thumb_1 = (hand_landmarks.landmark[hands.HandLandmark.THUMB_MCP].x * image_width,
                #            hand_landmarks.landmark[hands.HandLandmark.THUMB_MCP].y * image_height)
                # thumb_2 = (hand_landmarks.landmark[hands.HandLandmark.THUMB_IP].x * image_width,
                #            hand_landmarks.landmark[hands.HandLandmark.THUMB_IP].y * image_height)
                # thumb_3 = (hand_landmarks.landmark[hands.HandLandmark.THUMB_TIP].x * image_width,
                #            hand_landmarks.landmark[hands.HandLandmark.THUMB_TIP].y * image_height)
                # index_1 = (hand_landmarks.landmark[hands.HandLandmark.INDEX_FINGER_MCP].x * image_width,
                #            hand_landmarks.landmark[hands.HandLandmark.INDEX_FINGER_MCP].y * image_height)
                # index_2 = (hand_landmarks.landmark[hands.HandLandmark.INDEX_FINGER_PIP].x * image_width,
                #            hand_landmarks.landmark[hands.HandLandmark.INDEX_FINGER_PIP].y * image_height)
                # index_3 = (hand_landmarks.landmark[hands.HandLandmark.INDEX_FINGER_DIP].x * image_width,
                #            hand_landmarks.landmark[hands.HandLandmark.INDEX_FINGER_DIP].y * image_height)
                # index_4 = (hand_landmarks.landmark[hands.HandLandmark.INDEX_FINGER_TIP].x * image_width,
                #            hand_landmarks.landmark[hands.HandLandmark.INDEX_FINGER_TIP].y * image_height)
                # middle_1 = (hand_landmarks.landmark[hands.HandLandmark.MIDDLE_FINGER_MCP].x * image_width,
                #             hand_landmarks.landmark[hands.HandLandmark.MIDDLE_FINGER_MCP].y * image_height)
                # middle_2 = (hand_landmarks.landmark[hands.HandLandmark.MIDDLE_FINGER_PIP].x * image_width,
                #             hand_landmarks.landmark[hands.HandLandmark.MIDDLE_FINGER_PIP].y * image_height)
                # middle_3 = (hand_landmarks.landmark[hands.HandLandmark.MIDDLE_FINGER_DIP].x * image_width,
                #             hand_landmarks.landmark[hands.HandLandmark.MIDDLE_FINGER_DIP].y * image_height)
                # middle_4 = (hand_landmarks.landmark[hands.HandLandmark.MIDDLE_FINGER_TIP].x * image_width,
                #             hand_landmarks.landmark[hands.HandLandmark.MIDDLE_FINGER_TIP].y * image_height)
                # ring_1 = (hand_landmarks.landmark[hands.HandLandmark.RING_FINGER_MCP].x * image_width,
                #           hand_landmarks.landmark[hands.HandLandmark.RING_FINGER_MCP].y * image_height)
                # ring_2 = (hand_landmarks.landmark[hands.HandLandmark.RING_FINGER_PIP].x * image_width,
                #           hand_landmarks.landmark[hands.HandLandmark.RING_FINGER_PIP].y * image_height)
                # ring_3 = (hand_landmarks.landmark[hands.HandLandmark.RING_FINGER_DIP].x * image_width,
                #           hand_landmarks.landmark[hands.HandLandmark.RING_FINGER_DIP].y * image_height)
                # ring_4 = (hand_landmarks.landmark[hands.HandLandmark.RING_FINGER_TIP].x * image_width,
                #           hand_landmarks.landmark[hands.HandLandmark.RING_FINGER_TIP].y * image_height)
                # pinky_1 = (hand_landmarks.landmark[hands.HandLandmark.PINKY_MCP].x * image_width,
                #            hand_landmarks.landmark[hands.HandLandmark.PINKY_MCP].y * image_height)
                # pinky_2 = (hand_landmarks.landmark[hands.HandLandmark.PINKY_PIP].x * image_width,
                #            hand_landmarks.landmark[hands.HandLandmark.PINKY_PIP].y * image_height)
                # pinky_3 = (hand_landmarks.landmark[hands.HandLandmark.PINKY_DIP].x * image_width,
                #            hand_landmarks.landmark[hands.HandLandmark.PINKY_DIP].y * image_height)
                # pinky_4 = (hand_landmarks.landmark[hands.HandLandmark.PINKY_TIP].x * image_width,
                #            hand_landmarks.landmark[hands.HandLandmark.PINKY_TIP].y * image_height)
            for i in range(0, 20):
                sub_data = []
