...
class AudioPlayer():
    ...
    def run_eyes(self,stop):
        close = {'frames':[{"time": [0.33],"params": {"BLINK_LEFT": 1.0,'BLINK_RIGHT':1.0}},{"time":[2],"params":{"reset":True}}],"class": "furhatos.gestures.Gesture"}
        send_open = False
        while True:
    ...
    def blink_left(self,duration=1.0):
        gesture = {'frames':[{"time": [0.33],"params": {"BROW_DOWN_LEFT": 2.0}},{"time": [duration],"params": {"reset": True}}],"class": "furhatos.gestures.Gesture"}
        self.furhat.gesture(body=gesture)
        sleep(duration)
    def blink_right(self,duration=1.0):
        gesture = {'frames':[{"time": [0.33],"params": {"BROW_DOWN_RIGHT": 2.0}},{"time": [duration],"params": {"reset": True}}],"class": "furhatos.gestures.Gesture"}
        self.furhat.gesture(body=gesture)
        sleep(duration)
    def big_smile(self,duration=3.0):
        gesture = {'frames':[{"time": [1.0],"params": {"SMILE_OPEN": 1.0}},{"time": [duration+1.0],"params": {"reset": True}}],"class": "furhatos.gestures.Gesture"}
        self.furhat.gesture(body=gesture)
        sleep(duration)
    def surprise(self,duration=3.0):
        gesture = {'frames':[{"time": [1.0],"params": {"SURPRISE": 1.0}},{"time": [duration+1.0],"params": {"reset": True}}],"class": "furhatos.gestures.Gesture"}
        self.furhat.gesture(body=gesture)
        sleep(duration)
